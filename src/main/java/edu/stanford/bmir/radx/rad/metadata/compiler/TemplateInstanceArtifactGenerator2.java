...
public class TemplateInstanceArtifactGenerator2 {
  ...
  public TemplateInstanceArtifact generateTemplateArtifactInstance(Map<String, String> csvData,
    ...
    var csvDataManager = new CsvDataManager2();
    ...
    var elementInstanceArtifactGenerator = new ElementInstanceArtifactGenerator2(isFirstVersionTemplate, csvData, attributeValueMap, groupedData, fieldsCounts, elementCounts, templateSchemaArtifact);
  ...
  private void buildChildFieldInstances(String parentPath,
    ...
    var fieldInstanceArtifactGenerator = new FieldInstanceArtifactGenerator2();
  ...
  private void buildChildElementInstance(Map<String,String> csvData,
                                         TemplateSchemaArtifact templateSchemaArtifact,
                                         TemplateInstanceArtifact.Builder builder,
                                         ElementInstanceArtifactGenerator2 elementInstanceArtifactGenerator) throws URISyntaxException {
